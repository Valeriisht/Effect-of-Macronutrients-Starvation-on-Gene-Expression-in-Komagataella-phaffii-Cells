...
with tab2:
    ...
    with st.container():
        ...
        <li><strong>Phosphate:</strong> <span style='color: #1E90FF;'>1 g/L vs. 30 mg/L</span></li>
        <li><strong>Biotin:</strong> <span style='color: #1E90FF;'>400 µg/L vs. Biotin-free medium</span></li>
        </ul>
        </div>
        """, unsafe_allow_html=True)
